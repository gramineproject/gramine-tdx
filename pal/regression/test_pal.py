...
# Need to capture the output from VM/TDX in stdout as all guest console output will be redirected
# by QEMU to host's stdout
...
class TC_01_Bootstrap(RegressionTestCase):
    ...
    def test_140_missing_executable_and_manifest(self):
        if HAS_TDX or HAS_VM:
            ...
            # Guest reports the error and non-zero code on stdout; QEMU exits with 0.
